...
def read_description():
    ...
    description = description.replace(
        "//python-zhchess.readthedocs.io/en/latest/",
        "//python-zhchess.readthedocs.io/en/v{}/".format(zhchess.__version__))
...
setuptools.setup(
    ...
    author=zhchess.__author__,
    author_email=zhchess.__email__,
    description=zhchess.__doc__.replace("\n", " ").strip(),
