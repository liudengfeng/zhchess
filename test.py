...
class MoveTestCase(unittest.TestCase):
    ...
    def test_uci_parsing(self):
        ...
        self.assertEqual(zhchess.Move.from_uci("e7e8q").uci(), "e7e8q")
    ...
    def test_xboard_move(self):
        ...
        self.assertEqual(zhchess.Move.from_uci("e7e8q").xboard(), "e7e8q")
...
class PieceTestCase(unittest.TestCase):
    ...
    def test_from_symbol(self):
        ...
        black_queen = zhchess.Piece.from_symbol("q")
    ...
    def test_hash(self):
        pieces = {zhchess.Piece.from_symbol(symbol) for symbol in  "pnbrqkPNBRQK"}
