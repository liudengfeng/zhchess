...
try:
    class InfoDict(typing.TypedDict, total=False):
        ...
        tbhits: int
        multipv: int
        currmove: zhchess.Move
        currmovenumber: int
        hashfull: int
        cpuload: int
        refutation: Dict[zhchess.Move, List[zhchess.Move]]
        currline: Dict[int, List[zhchess.Move]]
        ebf: float
        wdl: PovWdl
        string: str
except AttributeError:
...
class Protocol(asyncio.SubprocessProtocol, metaclass=abc.ABCMeta):
    ...
    @abc.abstractmethod
    async def play(self, board: zhchess.Board, limit: Limit, *, game: object = None, info: Info = INFO_NONE, ponder: bool = False, draw_offered: bool = False, root_moves: Optional[Iterable[zhchess.Move]] = None, options: ConfigMapping = {}, opponent: Optional[Opponent] = None) -> PlayResult:
        """
        Plays a position.
    ...
    @typing.overload
    async def analyse(self, board: zhchess.Board, limit: Limit, *, game: object = None, info: Info = INFO_ALL, root_moves: Optional[Iterable[zhchess.Move]] = None, options: ConfigMapping = {}) -> InfoDict: ...
    @typing.overload
    async def analyse(self, board: zhchess.Board, limit: Limit, *, multipv: int, game: object = None, info: Info = INFO_ALL, root_moves: Optional[Iterable[zhchess.Move]] = None, options: ConfigMapping = {}) -> List[InfoDict]: ...
    @typing.overload
    ...
    @abc.abstractmethod
    async def analysis(self, board: zhchess.Board, limit: Optional[Limit] = None, *, multipv: Optional[int] = None, game: object = None, info: Info = INFO_ALL, root_moves: Optional[Iterable[zhchess.Move]] = None, options: ConfigMapping = {}) -> AnalysisResult:
        """
...
class UciProtocol(Protocol):
    ...
    def __init__(self) -> None:
        ...
        self.id = {}
        self.board = zhchess.Board()
        self.game: object = None
        self.first_game = True
        self.may_ponderhit: Optional[zhchess.Board] = None
    ...
    def _position(self, board: zhchess.Board) -> None:
    ...
    def _go(self, limit: Limit, *, root_moves: Optional[Iterable[zhchess.Move]] = None, ponder: bool = False, infinite: bool = False) -> None:
        builder = ["go"]
        if ponder:
    ...
    async def play(self, board: zhchess.Board, limit: Limit, *, game: object = None, info: Info = INFO_NONE, ponder: bool = False, draw_offered: bool = False, root_moves: Optional[Iterable[zhchess.Move]] = None, options: ConfigMapping = {}, opponent: Optional[Opponent] = None) -> PlayResult:
        ...
        class UciPlayCommand(BaseCommand[UciProtocol, PlayResult]):
            ...
            def start(self, engine: UciProtocol) -> None:
                self.info: InfoDict = {}
                self.pondering: Optional[zhchess.Board] = None
                ...
                if self.pondering:
                    ...
                    if ponder and best.move and best.ponder:
                        ...
                        if ponder_limit.black_clock is not None:
                            ...
                            if self.pondering.turn == zhchess.BLACK:
...
def _parse_uci_info(arg: str, root_board: zhchess.Board, selector: Info = INFO_ALL) -> InfoDict:
    info: InfoDict = {}
    if not selector:
        return info
    ...
    while tokens:
        ...
        if parameter == "string":
            ...
            try:
                info["currmove"] = zhchess.Move.from_uci(tokens.pop(0))
            except (ValueError, IndexError):
...
def _parse_uci_bestmove(board: zhchess.Board, args: str) -> BestMove:
    tokens = args.split()
...
class XBoardProtocol(Protocol):
    ...
    def _new(self, board: zhchess.Board, game: object, options: ConfigMapping, opponent: Optional[Opponent] = None) -> None:
        ...
        if new_game:
            fen = root.fen(shredder=board.chess960, en_passant="fen")
            if variant != "normal" or fen != zhchess.STARTING_FEN or board.chess960:
    ...
    async def analysis(self, board: zhchess.Board, limit: Optional[Limit] = None, *, multipv: Optional[int] = None, game: object = None, info: Info = INFO_ALL, root_moves: Optional[Iterable[zhchess.Move]] = None, options: ConfigMapping = {}) -> AnalysisResult:
        ...
        class XBoardAnalysisCommand(BaseCommand[XBoardProtocol, AnalysisResult]):
            def start(self, engine: XBoardProtocol) -> None:
                self.stopped = False
                self.best_move: Optional[zhchess.Move] = None
                self.analysis = AnalysisResult(stop=lambda: self.cancel(engine))
...
def _parse_xboard_post(line: str, root_board: zhchess.Board, selector: Info = INFO_ALL) -> InfoDict:
...
class BestMove:
    ...
    def __init__(self, move: Optional[zhchess.Move], ponder: Optional[zhchess.Move]):
        self.move = move
        self.ponder = ponder
...
class AnalysisResult:
    ...
    multipv: List[zhchess.engine.InfoDict]
    """
...
class SimpleEngine:
    ...
    *timeout* seconds longer than expected (unless *timeout* is ``None``).
    ...
    def play(self, board: zhchess.Board, limit: Limit, *, game: object = None, info: Info = INFO_NONE, ponder: bool = False, draw_offered: bool = False, root_moves: Optional[Iterable[zhchess.Move]] = None, options: ConfigMapping = {}, opponent: Optional[Opponent] = None) -> PlayResult:
        with self._not_shut_down():
            coro = asyncio.wait_for(
    ...
    @typing.overload
    def analyse(self, board: zhchess.Board, limit: Limit, *, game: object = None, info: Info = INFO_ALL, root_moves: Optional[Iterable[zhchess.Move]] = None, options: ConfigMapping = {}) -> InfoDict: ...
    @typing.overload
    def analyse(self, board: zhchess.Board, limit: Limit, *, multipv: int, game: object = None, info: Info = INFO_ALL, root_moves: Optional[Iterable[zhchess.Move]] = None, options: ConfigMapping = {}) -> List[InfoDict]: ...
    @typing.overload
    def analyse(self, board: zhchess.Board, limit: Limit, *, multipv: Optional[int] = None, game: object = None, info: Info = INFO_ALL, root_moves: Optional[Iterable[zhchess.Move]] = None, options: ConfigMapping = {}) -> Union[InfoDict, List[InfoDict]]: ...
    def analyse(self, board: zhchess.Board, limit: Limit, *, multipv: Optional[int] = None, game: object = None, info: Info = INFO_ALL, root_moves: Optional[Iterable[zhchess.Move]] = None, options: ConfigMapping = {}) -> Union[InfoDict, List[InfoDict]]:
        with self._not_shut_down():
            coro = asyncio.wait_for(
    ...
    def analysis(self, board: zhchess.Board, limit: Optional[Limit] = None, *, multipv: Optional[int] = None, game: object = None, info: Info = INFO_ALL, root_moves: Optional[Iterable[zhchess.Move]] = None, options: ConfigMapping = {}) -> SimpleAnalysisResult:
        with self._not_shut_down():
            coro = asyncio.wait_for(
