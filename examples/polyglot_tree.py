...
def print_tree(args: argparse.Namespace, visited: Set[int], level: int = 0) -> None:
    ...
    zobrist_hash = zhchess.polyglot.zobrist_hash(args.board)
...
if __name__ == "__main__":
    ...
    parser.add_argument("book", type=zhchess.polyglot.open_reader)
    parser.add_argument("--depth", type=int, default=5)
    parser.add_argument("--fen", type=zhchess.Board, default=zhchess.Board(), dest="board")
